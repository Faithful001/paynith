...
import com.king.paynith.infrastructure.flutterwave.dto.FlutterwaveData;
import com.king.paynith.infrastructure.flutterwave.dto.FlutterwaveVAResponse;
    ...
    public VirtualAccountResult createVirtualAccount(User user, WalletCurrency currency) {
        ...
        try {
            Map<String, Object> body = Map.of(
                    ...
                    "tx_ref", "paynith_" + user.getId(),
                    "phonenumber", user.getPhoneNumber(),
                    "is_permanent", true,
                    "firstname", user.getFirstName(),
                    "lastname", user.getLastName(),
                    "narration", "PayNith wallet for " + user.getFirstName(),
