...
import com.king.paynith.common.util.JsonUtil;
import com.king.paynith.domain.idempotency.IdempotencyService;
...
import com.king.paynith.domain.transaction.TransactionService;
import com.king.paynith.domain.transaction.dto.CreateTransactionDto;
...
import com.king.paynith.domain.virtualaccount.VirtualAccountProviderFactory;
...
import com.king.paynith.domain.webhook.dto.FlutterwaveChargeCompletedResult;
import com.king.paynith.infrastructure.flutterwave.FlutterwaveService;
import com.king.paynith.infrastructure.flutterwave.dto.FlwChargeResponse;
...
public class WalletService {
    ...
    public TransactionResult debitWallet (String userId, WithdrawalDto payload){
        ...
        String reference = "paynith_withdrawal_" + UUID.randomUUID();
