package com.king.paynith.domain.bill;

import com.king.paynith.common.response.Response;
import com.king.paynith.domain.payment.dto.CreateBillPaymentDto;
import com.king.paynith.infrastructure.flutterwave.FlutterwaveService;
import com.king.paynith.infrastructure.flutterwave.dto.BillCategoryResult;
import com.king.paynith.infrastructure.flutterwave.dto.GetBillInfoResult;
import com.king.paynith.infrastructure.flutterwave.dto.GetBillerInfoResult;
import com.king.paynith.infrastructure.flutterwave.dto.ValidateCustomerDetailsResult;
...
public class BillController {
    ...
    public ResponseEntity<Response<Object>> createBillPayment(
        ...
        String reference = "paynith_bill_" + UUID.randomUUID() + "_PMCKDU_1";
